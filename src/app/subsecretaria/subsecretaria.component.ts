...
@Component({
  selector: 'app-subsecretaria',
  templateUrl: './subsecretaria.component.html',
  styleUrls: ['./subsecretaria.component.css'],
})
export class SubsecretariaComponent implements OnInit {
  mostrarInicio = true;
  mostrarTurnar = false;
