...
@Component({
  selector: 'app-subdireccion',
  templateUrl: './subdireccion.component.html',
  styleUrls: ['./subdireccion.component.css'],
})
export class SubdireccionComponent implements OnInit {
  mostrarInicio = true;
  mostrarTurnar = false;
